...
exports.build = function build(name, options) {
	if(_.isEmpty(name))
		throw new global._$Error('Name is not defined, you must define a name for the Error');
	...
	function AbstractError(options) {
		...
		if (global._$Error.captureStackTrace) {
			ctor = options ? options.constructorOpt : undefined;
			ctor = ctor || arguments.callee;
			global._$Error.captureStackTrace(this, ctor);
		}
	}

	util.inherits(AbstractError, global._$Error);
