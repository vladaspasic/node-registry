...
// Save a reference to on a original Error
global._$Error = global.Error;

var defaultErrors = {
	Error: factory.build('Error'),
	EvalError: factory.build('EvalError'),
	InternalError: factory.build('InternalError'),
	RangeError: factory.build('RangeError'),
	ReferenceError: factory.build('ReferenceError'),
	SyntaxError: factory.build('SyntaxError'),
	TypeError: factory.build('TypeError'),
	UriError: factory.build('UriError'),
