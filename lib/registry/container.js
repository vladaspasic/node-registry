...
Container.prototype = {
	 ...
	 */
	createRequestContainer: function(request, response) {
 ...
 * @param {Response}  response HTTP response
 */
var RequestContainer = function RequestContainer(parent, request, response) {
...
RequestContainer.prototype = Object.create(Container.prototype);

RequestContainer.prototype.lookupFactory = function(name) {
	var factory = Container.prototype.lookupFactory.apply(this, arguments);
